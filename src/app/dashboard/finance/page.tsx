...
export default function FinanceDashboard() {
  ...
  const quickLinks = [
    { href: '/dashboard/finance/tuition/collect', icon: Receipt, label: 'Collect Fees', desc: 'Student payments' },
    { href: '/dashboard/finance/fee-structure', icon: Gear, label: 'Fee Structure', desc: 'Grade fee rates' },
    { href: '/dashboard/finance/tuition/overdue', icon: Warning, label: 'Overdue Fees', desc: 'Defaulter list' },
    { href: '/dashboard/finance/daily-closing', icon: CreditCard, label: 'Daily Closing', desc: 'Cash reconciliation' },
    { href: '/dashboard/finance/income', icon: TrendUp, label: 'Other Income', desc: 'Grants & donations' },
    { href: '/dashboard/finance/expense', icon: TrendDown, label: 'Expenses', desc: 'Bills & operational' },
    { href: '/dashboard/finance/salary/pay', icon: Users, label: 'Pay Salary', desc: 'Staff payroll' },
    { href: '/dashboard/finance/report/monthly', icon: ChartBar, label: 'Monthly Report', desc: 'Financial audit' },
  ];
        ...
        <div className="lg:col-span-4 space-y-3">
          ...
          <div className="bg-card rounded-2xl p-4 sm:p-5 border border-border/80 shadow-xs h-full flex flex-col justify-between">
            ...
            <div className="pt-3 mt-3 border-t border-border/60">
              <Link href="/dashboard/finance/tuition/collect" className="text-xs font-semibold text-primary hover:underline flex items-center justify-center gap-1">
