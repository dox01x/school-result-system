...
export default function YearlyReportPage() {
  ...
  return (
    <div className="space-y-6 print:m-0 print:p-0">
      ...
      {/* Funnels */}
      <Card className="print:hidden border border-border rounded-xl shadow-none">
      ...
      {loading ? (
        ...
        <div className="print:block bg-card text-black space-y-6 pt-4 rounded-xl print:rounded-none">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
             <div className="bg-muted/50 border border-border p-5 rounded-xl text-center flex flex-col justify-center items-center shadow-none">
          ...
          <div className="space-y-4">
              <h3 className="text-[12px] font-bold uppercase tracking-widest text-muted-foreground border-b border-border pb-2">Monthly Breakdown</h3>
              <Table>
                <TableHeader>
