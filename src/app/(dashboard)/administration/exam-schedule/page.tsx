...
export default function ExamSchedulePage() {
    ...
    const handlePrint = () => {
        ...
        const headerCells = examDates.map((date) => {
            ...
            return `<th><div class="p-num">${formatted}</div><div class="p-time">${day}</div></th>`;
        }).join("");
...
table.main-table { width: 100%; border-collapse: collapse; border: 1.5px solid #334155; background: #ffffff; }

table.main-table thead th { background: #f1f5f9 !important; color: #0f172a; padding: 8px 4px; text-align: center; border: 1px solid #334155; vertical-align: middle; }
table.main-table thead th.day-th { width: 90px; min-width: 90px; font-size: 11px; font-weight: 800; letter-spacing: 0.8px; text-transform: uppercase; border: 1px solid #334155; }

.p-num { font-size: 9.5px; font-weight: 800; letter-spacing: 0.5px; text-transform: uppercase; color: #0f172a; }
.p-time { font-size: 8px; font-weight: 600; color: #475569; margin-top: 1px; text-transform: uppercase; }

table.main-table tbody tr { min-height: 40px; }
table.main-table tbody td { padding: 6px 4px; text-align: center; vertical-align: middle; border: 1px solid #334155; background: #ffffff; }

td.day-col { font-weight: 800; font-size: 10.5px; text-transform: uppercase; letter-spacing: 0.5px; width: 90px; min-width: 90px; color: #0f172a; background: #f8fafc !important; border: 1px solid #334155; text-align: center; }
td.empty { background: #ffffff !important; color: #94a3b8; font-size: 14px; font-weight: 300; }

.subj { font-weight: 700; font-size: 10.5px; color: #0f172a; line-height: 1.25; }
.multi-sep { border-top: 1px dashed #cbd5e1; margin: 3px 0; }

/* Instructions */
.inst-section { margin-top: 10px; background: #f8fafc !important; border: 1.5px solid #334155; border-radius: 6px; padding: 8px 14px; }
.inst-section h4 { font-size: 10.5px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.6px; color: #0f172a; margin-bottom: 4px; }
.inst-section ul { list-style: none; padding: 0; color: #334155; }
.inst-section li { font-size: 9.5px; line-height: 1.4; display: flex; align-items: flex-start; gap: 4px; color: #334155; }
.inst-num { font-weight: 800; min-width: 16px; color: #0f172a; }

/* Signature Section */
.sigs { width: 100%; table-layout: fixed; margin-top: 28px; border-collapse: collapse; border: none; }
...
.footer-note { text-align: center; font-size: 8.5px; color: #94a3b8; margin-top: 12px; font-weight: 500; letter-spacing: 0.4px; }
</style></head><body>
<div class="pg">
...
<div class="tbar">
<div class="badge-title">${examName}</div>
<div class="badge-scope">${getShiftDisplayName(selectedShift).toUpperCase()} &bull; TIME: ${formatTime12(selectedShift.start_time)} TO ${formatTime12(selectedShift.end_time)}</div>
<div class="badge-meta">Issued: ${new Date().toLocaleDateString("en-US", { year: "numeric", month: "short", day: "numeric" })}</div>
</div>

<table class="main-table">
<thead><tr><th class="day-th">Class</th>${headerCells}</tr></thead>
