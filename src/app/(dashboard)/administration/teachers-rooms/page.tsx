...
import { prefetchTeacherProfile } from "@/components/teachers/teacher-profile-sheet";
                                ...
                                <TableBody>
                                    {filteredTeachers.map((t) => (
                                        <TableRow
                                            ...
                                            onMouseEnter={() => prefetchTeacherProfile(t.id)}
                                            onClick={() => { setSelectedTeacherId(t.id); setProfileDialogOpen(true); }}
                                        >
